    ...
    <Box className="relative w-full">
      <Box className="relative flex items-center">
        ...
        <input
          ...
          className="w-full h-[4rem] rounded-full border border-black/5 bg-[#F6F6F8] pl-14 pr-6 text-[16px] font-medium text-neutral-900 outline-none transition focus:border-black focus:bg-white focus:shadow-lg"
          aria-label="Search"
        />
      </Box>
