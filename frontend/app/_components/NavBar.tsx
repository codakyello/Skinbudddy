...
function SideBar({
  ...
  return (
    <>
      ...
      <Box
        className={`overflow-y-auto flex flex-col gap-16 bg-white p-4 fixed left-0 top-0 bottom-0 w-[350px] transition-transform duration-300 ${isOpen ? "translate-x-0" : "translate-x-[-100%]"}`}
      >
        <Box className="flex">
          <Box
