...
// export interface ChatCompletionDialogueAgentOptions
//   extends DialogueAgentOptions {
...
//     });
//     this.items = [
//       { type: "message", role: "assistant", content: this.getInitialMessage() },
//     ];
//   }

//   getCCMessages(context: DialogueContext): ChatCompletionMessageParam[] {
//     const trajectory =
//       (this.requestOptions?.type === "chat_completions" &&
//         this.requestOptions.messages) ||
//       [];
...
//     const { type: _deprecatedType, ...params } = (this.requestOptions ??
